...
4.  db.addresses.find({ },{ restaurant_id: 1, name: 1, borough:1, _id:0, 'address.zipcode':1 })
...
11. db.addresses.find({$and:[{"cuisine" : {$ne :"American "}},
            {"grades.score" : {$gt : 70}},
...
17. db.addresses.find({ "borough": "Bronx" , 
